...
import { toggleActiveOrInactive } from '../../../controller/superAdminController/superAdminShop/superAdmin.shop.controller.js';
...
superAdminRouter.patch('/shops/:id/active-toggle', userVerifyToken, checkUserRole("super-admin"), toggleActiveOrInactive);
