...
import { addBillingAddressToCustomer, addShippingAddressToCustomer, createCustomInvoiceCustomer, createCustomProductForCustomInvoice, getCustomCustomerAddress, getCustomCustomerForForm, getCustomCustomerInvoice } from "../../../controller/customInvoiceController/index.js";


const customInvoiceRouter = express.Router();

customInvoiceRouter.post('/product/create', shopVerifyToken, userVerifyToken, checkUserRole('admin', 'staff'), createCustomProductForCustomInvoice)
