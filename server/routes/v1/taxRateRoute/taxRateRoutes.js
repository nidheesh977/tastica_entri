...
import { addTaxRatesToAccount, createTaxRateAccount, getTaxRateForCustomInvoice, getTaxRatesForExpenseForm, getTaxRatesForShop, taxRateStatusUpdate } from "../../../controller/taxController/index.js";
...
taxRateRouter.get("/custom-invoice/form", shopVerifyToken, userVerifyToken, checkUserRole('admin', 'staff'), getTaxRateForCustomInvoice)
