...
import { createExpenseAccount, addNewExpenseInAccount, getExpenseAccountForExpenseForm, getExpenseAccounts, getSingleExpenseAccount, deleteExpenseAccountTitle, expenseAccountStatusUpdate, getExpenseAccountHeadForm } from "../../../controller/expenseAccoutController/index.js";
...
expenseAccountRouter.get("/title", shopVerifyToken, userVerifyToken, checkUserRole('admin', 'staff'), getExpenseAccountHeadForm)
