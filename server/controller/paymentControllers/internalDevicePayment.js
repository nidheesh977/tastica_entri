           ...
           //  pointAmount:parseFloat(PointsToAmount).toFixed(2),
             ...
             const loyalityEarned = loyalityTransactionModel({
                        ...
                        await loyalityEarned.save()
                         ...
                         await walletModel.findOneAndUpdate({customerId:invoiceInternalDevicePayment.customer},{$inc:{balance:Math.round(loyaltyPointProduct)}},{new:true}).populate("customerId","customerName")
