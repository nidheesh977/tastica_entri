...
export const CreditAddBox = ({ setOpenRegisterDialog, invoiceNumber, totalAmount, title, invoiceId, setShowCreditDialog, resetBillingState, }) => {
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col items-center justify-end mt-5 gap-3'>
                ...
                <button className='w-32 h-10 bg-primary mt-5 rounded-md text-white  disabled:opacity-40' disabled={!isFormValid || isPending}>{isPending ? "Adding..." : "Add"}</button>
            </form>
